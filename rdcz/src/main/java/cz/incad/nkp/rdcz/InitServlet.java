...
public class InitServlet extends HttpServlet {
  ...
  public static final String APP_DIR_KEY = "rdcz_app_dir";

  //Directory where cant override configuration  
  public static String CONFIG_DIR = ".rdcz";
  ...
  public void init() throws ServletException {
    ...
    LOGGER.log(Level.INFO, "default config file is dir is {0}", DEFAULT_CONFIG_FILE);
    ...
    try {
      ...
      AppScheduler sched = new AppScheduler();
      sched.getJobs();
      AppScheduler.getInstance().getScheduler().start();
    } catch (SchedulerException ex) {
      LOGGER.log(Level.SEVERE, null, ex);
    }
