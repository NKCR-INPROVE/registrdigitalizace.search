...
public class Options {
  ...
  public Options() throws IOException, JSONException {
    ...
    if(fdef.exists()){
      ...
      LOGGER.log(Level.WARNING, "Working without client configuration");
    }
    ...
    //Get server options
    File fserver = FileUtils.toFile(Options.class.getResource("/cz/incad/nkp/rdcz/server_config.json"));
